<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateFree.master" AutoEventWireup="true" CodeFile="FreeTemplateSignUp.aspx.cs" Inherits="FreeTemplateSignUp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<h1>Sign Up:</h1> <asp:Label ID="Labelerror" runat="server" Text="Label" Visible="false"></asp:Label>
<table class="table" style="width:80%">
<tr>
<td style="width:50%">Email:<b><asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
ControlToValidate="emailC"
ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
ErrorMessage=" Please enter a valid email address"
runat="server" /> </b> <asp:TextBox ID="EmailC" runat="server" class="form-control"></asp:TextBox></td>
<td style="width:50%">Password:  <asp:TextBox ID="PassC" runat="server" class="form-control" TextMode="Password"></asp:TextBox></td>
</tr>
<tr>
<td style="width:50%">First Name:<asp:TextBox ID="Fn" runat="server" class="form-control"></asp:TextBox></td>
<td style="width:50%">Last Name:  <asp:TextBox ID="Ln" runat="server" class="form-control"></asp:TextBox></td>
</tr>
<tr>
<td style="width:50%">Country:<br /><table class="table">
<tr><td>
<asp:DropDownList ID="ddlCountry" runat="server" class="btn btn-default dropdown-toggle">
...
<td style="width:50%">Birthday: <asp:ScriptManager ID="sc" runat="server">
  </asp:ScriptManager>
 <table class="table">
    <tr>
      <td>
        <asp:UpdatePanel ID="updpnlMonth" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
          <ContentTemplate>
            <asp:DropDownList ID="ddlMonth" class="btn btn-default dropdown-toggle" runat="server" AutoPostBack="true" DataTextField="MonthName"
      ...
      <td>
        <asp:UpdatePanel ID="updpnlDay" runat="server" UpdateMode="Conditional">
          <ContentTemplate>
            <asp:DropDownList ID="ddlday" class="btn btn-default dropdown-toggle" runat="server">
            </asp:DropDownList>
          </ContentTemplate>
          <Triggers>
      ...
      <td>
        <asp:DropDownList ID="ddlYear" class="btn btn-default dropdown-toggle" runat="server">
        </asp:DropDownList>
      </td>
    </tr>
  </table></td>
...
<tr>
<td style="width:50%">Sex:<asp:RadioButtonList ID="sex" RepeatDirection="Horizontal" runat="server" >
                                     <asp:ListItem Value="Female" >Female&nbsp;&nbsp;</asp:ListItem>
                                     <asp:ListItem Value="Male">Male</asp:ListItem></asp:RadioButtonList></td>
<td style="width:50%" align="right"><asp:Button ID="SignUp0" runat="server" 
        Text="Sign Up" class="btn btn-primary btn-lg" onclick="SignUp0_Click" /></td>
</tr>
